...
theme_path = "/home/lech/.config/awesome/themes/k2.lua"
...
mytextbox.text = "<b><small> MATRIX HAS YOU </small></b>"
...
awful.hooks.timer.register(1, function ()
    mytextbox.text = os.date(" %Y-%m-%d, %H:%M:%S ")
end)
-- }}}
