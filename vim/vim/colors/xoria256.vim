...
hi FoldColumn   ctermfg=248 guifg=#a8a8a8 ctermbg=238  guibg=#1c1c1c
...
""" vimdiff
hi diffAdd      ctermfg=238  guifg=bg      ctermbg=151 guibg=#afdfaf
"hi diffDelete   ctermfg=bg  guifg=bg      ctermbg=186 guibg=#dfdf87 cterm=none gui=none
hi diffDelete   ctermfg=238  guifg=bg      ctermbg=246 guibg=#949494 cterm=none gui=none
hi diffChange   ctermfg=238  guifg=bg      ctermbg=181 guibg=#dfafaf
hi diffText     ctermfg=238  guifg=bg      ctermbg=174 guibg=#df8787 cterm=none gui=none
